...
#define BLYNK_TEMPLATE_ID "TMPL2tAhdxgH1"
#define BLYNK_TEMPLATE_NAME "Smart Parking système"
#define BLYNK_AUTH_TOKEN "UI6IvxEbtW1dNKttUpzMJzup4KYhS0n-" 

#include <WiFi.h>
#include <WiFiClient.h>
#include <BlynkSimpleEsp32.h>

char ssid[] = "AndroidAP2950";   // Nom du réseau depuis Wi-Fi Options
char pass[] = "rkeh8059";       // Mot de passe que tu as défini
...
void checkTemperature() {
  if(millis() - lastTempCheck > 2000) {
    ...
    if(temperature > 40.0) {
      ...
      BuzzOff(); // Désactive si température redescend
    }
    
    lastTempCheck = millis();
  }
  Blynk.virtualWrite(V9, temperature); // Température sur V9
}
...
//-----------------------------------
void BuzzOn(){
  tone(BuzzPin, 1000); // 1kHz en continu
}
